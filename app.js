...
const translations = {
  ru: {
    ...
    heroSubtitle:   "Система подготовки, воспитавшая чемпионов мирового класса — от Олимпийских залов СССР до профессионального ринга. Та же школа, что стоит за такими бойцами, как Бивол.",
    heroCtaPrimary: "Записаться на аудит",
    heroGuarantee:  "Советская боксёрская школа — это не стиль. Это система, проверенная десятилетиями чемпионства.",
    ...
    pillarsDesc:  "Та самая система, которая вырастила Бивола, Ломаченко и Усика. Дисциплина, интеллект и безупречная техника вместо грубой силы.",

    pillar1Title: "Железная Защита и Стойка",
    pillar1Text:  "Советская школа строит боксёра с защиты, а не с удара. Глухой высокий гард, минимальные движения головы в нужный момент и плотный локоть — именно так Бивол выходит из боя чистым. Ни одного лишнего движения.",
    ...
    pillar2Text:  "Советский джеб — это не просто укол. Это инструмент измерения дистанции, нарушения ритма и создания углов для удара правой. Именно так Бивол разбивает чужие тайминги — не силой, а тактическим превосходством.",
    ...
    pillar3Text:  "Советские боксёры не гонятся за соперником — они заставляют его идти туда, где уже стоит удар. Терпение, позиционный контроль и точный контрудар в момент ошибки оппонента — основа чемпионского бокса по Биволу.",
    ...
    coachQuote: '"Бивол не бьёт сильнее других. Он никогда не стоит там, где ему могут попасть. Именно этому я учу."',
  ...
  en: {
    ...
    heroSubtitle:   "The same boxing system behind world champions like Bivol — built on an educated guard, a disciplined jab, and the patience to counter. Not power. Science.",
    heroCtaPrimary: "Book Your Assessment",
    heroGuarantee:  "Soviet boxing school is not a style. It is a system — proven across decades of Olympic and world championship gold.",
    ...
    pillarsDesc:  "The system that produced Bivol, Lomachenko, and Usyk. Discipline, intelligence, and airtight technique over raw aggression.",

    pillar1Title: "The Educated Guard",
    pillar1Text:  "Soviet boxing builds the fighter from the defence outward. A high, tight guard with the shoulder kissing the chin — the same guard that lets Bivol walk through exchanges untouched. Minimal movement, maximum coverage.",
    ...
    pillar2Text:  "In Soviet boxing, the jab is not an attack — it is a measuring stick, a rhythm breaker, and an angle-setter for the right hand. This is how Bivol dismantles fighters without chasing them: he controls space until they walk into his shot.",
    ...
    pillar3Text:  "Soviet champions do not chase — they position. They control the ring, absorb nothing, and punish every mistake with surgical precision. The counter, thrown at the exact moment of opponent commitment, is the signature of Soviet-school professionals like Bivol.",
    ...
    cp2Desc:  "Your guard, jab, and counter timing reviewed against the Soviet school standard — the same standard Bivol is held to.",
    coachQuote: '"Bivol does not hit harder than other champions. He is never standing where they can hit him. That is what I teach."',
